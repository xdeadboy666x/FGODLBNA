            ...
            if num_value is not None:
                ...
                if mana_s == 0:
                   main.logger.info(f"\n ======================================== \n 魔力棱镜不足(´･ω･`) \n ======================================== ")
                    ...
                    if num is not None:
                       main.logger.info(f"\n ======================================== \n Redeemed {num} summon tickets (per month) \n ======================================== ")
                ...
                if item.get('baseShopId') == max_base_shop_s_id:
                    ...
                    if response.status_code == 200:
                        ...
                        if current_time > closedAt:
                            main.logger.info(f"\n ======================================== \n There's no Mana Prism Event at this time.(´･ω･`) \n ======================================== ")
                            return
                        else:
                            with open('login.json', 'r', encoding='utf-8') as file:
                                 gdata = json.load(file)
                            ...
                            if num_value is not None:
                               num_ok = 5 - num_value
                               if num_ok == 0:
                                   main.logger.info(f"\n ======================================== \n You've already redeemed the event summon ticket (´･ω･`) \n ======================================== ")
                                   return
                               else:
                                    if mana_s == 0:
                                    ...
                                    data = self.Post(
                                        f'{fgourl.server_addr_}/shop/purchase?_userId={self.user_id_}') 
                                    if num is not None:
                                       main.logger.info(f"\n ======================================== \n Redeemed {num} summon tickets (limited time event) \n ======================================== ")
                            else:
                                 num_ok = 5
                                 mana = gdata['cache']['replaced']['userGame'][0]['mana']
                                 mana_s = mana // 20
