...
| GAME_REGION | JP |
| GAME_USERAGENT | Dalvik/2.1.0 (Linux; U; Android 14; Pixel 5 Build/UP1A.231105.001) It is not recommended to change this, but if you decide to do so, you will also need to update the [Device Information].|
